...
$SQL="select prodId, prodName, prodPicNameLarge,prodDescripLong ,prodPrice , prodQuanitity from product WHERE prodId=".$prodid;
...
echo "<select name = p_quantity id='select'>";
for($i=1;$i<=$arrayp['prodQuanitity'];$i++){
